        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-16">
          ...
          <div className="lg:w-80 flex-shrink-0">
            ...
            <div className="w-48 h-48 rounded-2xl bg-gradient-to-br from-[#f97316]/20 via-[#f97316]/10 to-transparent flex items-center justify-center mb-6 border border-[#f97316]/20">
              <span className="text-[#f97316] font-bold text-6xl">NN</span>
            </div>
          ...
          <div className="flex-1 lg:pt-4">
            ...
            <div className="space-y-6 text-[16px] text-gray-300 leading-relaxed">
              <p>
                Nicholas Norman is an Account Executive in KDT. He grew up in a small town in Northeast Texas, where he developed a strong work ethic and a dedication to leadership. After graduating, he built his career in the construction trade, gaining years of valuable leadership experience.
              </p>
              <p>
                Later, he moved his family to Dallas and transitioned into a sales role with one of Texas' most prestigious remodeling companies, sharpening his expertise in client relations and sales.
              </p>
              
              <div className="pt-4">
                <h3 className="text-[20px] font-semibold text-white mb-4">Passions & Values</h3>
                <p className="mb-4">
                  Nicholas' passions include leading his family in alignment with God's will, coaching Special Olympic athletes at the Area and State levels, and continuously seeking opportunities for personal growth.
                </p>
                <p className="mb-4">
                  In his free time, he creates individual first aid and emergency preparedness kits for friends and loved ones, reflecting his commitment to service and care.
                </p>
                <p className="text-white font-medium">
                  As an excellent Account Executive in KDT, Nicholas embodies the values of integrity, excellence, and virtue. His Christ-centered leadership and dedication to his work make him an indispensable part of the KDT team.
                </p>
              </div>
            </div>
          </div>
